...
- [7. 구현 제약 및 확장 가능성](#7-구현-제약-및-확장-가능성)
- [8. 기술 스택](#8-기술-스택)
- [9. 팀 구성](#9-팀-구성)
...
> ⏰ 프로젝트 기간: 2026.08.18 ~ 2026.08.24 (Physical AI Engineer 부트캠프 Project 1)
...
<!-- ![매장배치도](./documents/images/floorplan.png) -->

카메라(계산대·픽업존) · 디스펜싱 타워(서보 4개 + 스텝모터 + IR센서) · 픽업존(고정 슬롯 3개 + RFID 리더)으로 구성됩니다.

## 시스템 아키텍처

<!-- ![시스템아키텍처](./documents/images/system_architecture.png) -->
...
<!-- ![상품출고](./assets/images/dispense.gif) -->
...
<!-- ![모니터링](./assets/images/monitoring.gif) -->
...
<!-- 팀원 정보를 실제 내용으로 채워주세요 -->

| 이름 | 담당 |
|---|---|
| (본인) | DB 설계 · Confluence 문서 관리 · 하드웨어(디스펜싱/픽업 보드) |
| | |
| | |
| | |
| | |
